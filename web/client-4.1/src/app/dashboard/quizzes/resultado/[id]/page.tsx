...
import { Quiz, QuestaoQuiz, OpcaoQuiz } from "@/types/quiz";
    ...
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center h-[60vh]">
          ...
          <p className="mt-4 text-orange-800">Carregando resultado...</p>
        </div>
      </DashboardLayout>
    );
  }
    ...
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center h-[60vh]">
          ...
          <p className="mt-4 text-orange-800">Quiz não encontrado</p>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold text-orange-900">{quiz.titulo}</h1>
            <p className="text-orange-700">{disciplinaNome}</p>
          </div>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm">
                ...
                <span className="text-sm text-orange-700">Pontuação</span>
              ...
              <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm">
                ...
                <span className="text-sm text-orange-700">Acertos</span>
              ...
              <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm">
                ...
                <span className="text-sm text-orange-700">Tempo Total</span>
              ...
              <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm">
                <div className="flex items-center space-x-2 mb-2">
                  <span className="font-medium text-orange-900">Resultado:</span>
                  <span className={`font-medium ${
                    tentativaAtual.percentualAcerto >= 0.7 
                      ? "text-green-600" 
                      : tentativaAtual.percentualAcerto >= 0.5 
                      ? "text-orange-600" 
                      : "text-red-600"
                  }`}>
                    {tentativaAtual.percentualAcerto >= 0.7 
        ...
        <h2 className="text-xl font-bold text-orange-900 mb-4">Respostas</h2>
        
        <div className="space-y-4">
          {tentativaAtual.respostas.map((resposta, index) => {
            const questao = quiz.questoes.find(q => q._id === resposta.questao);
                      ...
                      {questao.opcoes.map(opcao => (
                        <div
                          ...
                          className={`p-3 rounded-lg border ${
                            opcao._id === resposta.alternativa
                              ? opcao.correta
                        ...
                        >
                          <div className="flex items-start space-x-2">
                            {opcao._id === resposta.alternativa && opcao.correta && (
