...
import { Provincia, CreateProvinciaInput, UpdateProvinciaInput } from "@/types/provincia"
...
export default function ProvinciasPage() {
  ...
  // Funções CRUD que cumprem o contrato de Promise para os formulários
  const handleCreateProvincia = async (data: CreateProvinciaInput) => {
    await createMutation.mutateAsync(data);
  }

  const handleUpdateProvincia = async (id: string, data: UpdateProvinciaInput) => {
                      ...
                      <TableRowActions
                        ...
                        deleteTrigger={
                          <ConfirmDialog
                            ...
                            description={`Tem certeza que deseja excluir a província ${provincia.nome}?`}
